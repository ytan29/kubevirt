...
func (in *Devices) DeepCopyInto(out *Devices) {
	*out = *in
	...
	if in.Displays != nil {
		in, out := &in.Displays, &out.Displays
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DisplayHostDevice) DeepCopyInto(out *DisplayHostDevice) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DisplayHostDevice.
func (in *DisplayHostDevice) DeepCopy() *DisplayHostDevice {
	if in == nil {
		return nil
	}
	out := new(DisplayHostDevice)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PermittedHostDevices) DeepCopyInto(out *PermittedHostDevices) {
	*out = *in
	...
	if in.DisplayDevices != nil {
		in, out := &in.DisplayDevices, &out.DisplayDevices
		*out = make([]DisplayHostDevice, len(*in))
		copy(*out, *in)
	}
	return
}
